<div class="container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative">
        ...
        <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <defs>
                ...
                <linearGradient id="linear-gradient-9" x1="1046.73" y1="383.6" x2="1112" y2="382.91"
                    gradientTransform="matrix(-0.72, -0.23, -0.4, 0.83, 1082.07, 67.22)" gradientUnits="userSpaceOnUse">
            ...
            <g style="isolation:isolate">
                <g id="Capa_1" data-name="Capa 1">
                    ...
                    <path d="M128.61,69s0,2.37-1.34,2.64c-1.73.37-1.83-1.48-1.78-2.74A3,3,0,0,1,128.61,69Z"
                        style="fill:#fff" />
                    <path d="M128.62,69.36c.41.13-.1,1.31-.3,1.49a1.21,1.21,0,0,1-1.63.13c-1.25-.72-.47-2.39-.47-2.39Z"
                        style="fill:#4c323a" />
                    ...
                    <path d="M108.92,115.93s8.57,76.75,10.2,85.45l-5.58,11.09s-9.36-6.41-9.9-10-1.26-86.18-1.26-86.18Z"
                    ...
                    <path
                        ...
                        style="fill:#e7bfaa" />
                    <polygon points="112.65 107.07 108.92 115.93 102.38 116.25 92.58 105.75 106.89 105.34 112.65 107.07"
    ...
    <div
        ...
        <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">Quản lý thông tin</h1>
        <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900">Website là nơi giúp bạn có thể dễ dàng chỉnh sửa thông
            tin sinh viên giáo viên điểm số và còn nhiều hơn nữa...</p>
        <a href="#" class="font-semibold text-lg bg-purple-600 hover:bg-blue-400 text-white py-3 px-12 rounded-full">Tìm
            hiểu thêm</a>
    </div>
    <svg class="w-full absolute bottom-0 left-0" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg"
