...
<body x-data="{ showModal1: false , showModal2: false, showModal3: false  }" :class="{'overflow-y-hidden': showModal1}">
    ...
    <div class="fixed inset-0 w-full h-full z-20 bg-black bg-opacity-50 duration-300 overflow-y-auto"
        ...
        <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
            <div class="relative bg-white shadow-lg rounded-md text-gray-900 z-20" @click.away="showModal1 = false"
                ...
                <form action="../point/editPoint" method="post">
                    <div class="px-5 py-7">
                        <input hidden id="subject_id" name="subject_id">
                        <input hidden id="students_id" name="students_id">
                        <label class="font-semibold text-sm text-gray-600 pb-1 block">Số lần thi</label>
                        <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full"
                            id="times" name="times" />
                        <label class="font-semibold text-sm text-gray-600 pb-1 block">Điểm</label>
                        <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full"
                            id="point" name="point" />
                ...
                <div class="flex flex-col sm:flex-row mt-10">
                    <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                        ...
                        <div class="flex flex-col items-center text-center justify-center">
                            <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">QUẢN LÝ ĐIỂM THI</h2>
                            <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                            <p class="text-base">Bạn có thể xem và chỉnh sửa thông tin điểm thi.</p>
                        </div>
                    </div>
                    <div
                        ...
                        <table class="min-w-max w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th class="py-3 px-6 text-left">Tên môn</th>
                                    <th class="py-3 px-6 text-center">Số lần thi</th>
                                    <th class="py-3 px-6 text-center">Điểm</th>
                                        ...
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                ...
                                                <a herf="javascript:void(0)"
                                                    onclick="edit_Data(<?php echo $data["subject_id"] ?>,'<?php echo $data["students_id"] ?>','<?php echo $data["times"] ?>','<?php echo $data["point"] ?>')">
    ...
    <script>
    function edit_Data(subject_id, students_id, times, point) {
    ...
    function delete_Data(student_id) {
        $student_id = "../point/deletePoint/" + student_id;
        document.getElementById("deletePoint").setAttribute("href", $student_id);
    }
